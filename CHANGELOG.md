...
- **ontodag range is now `>=0.16.0,<0.23.0`** — the ceiling rose because
  ontodag's release gate ran this suite against the 0.22.0 candidate (core
  v5, domain packs v2 after their second reading) and it passed unchanged.
  No code change.
...
- **ontodag range is now `>=0.16.0,<0.22.0`** — the ceiling rose because
  ontodag's release gate ran this suite against the 0.21.0 candidate (the
  ten domain packs in the wheel) and it passed unchanged. No code change.
